...
HD_PWD='Z:/25Spring/Vivado_lab/projects/project_2/project_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log irom_test_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source irom_test_top.tcl
