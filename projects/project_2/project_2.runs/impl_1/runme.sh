...
HD_PWD='Z:/25Spring/Vivado_lab/projects/project_2/project_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log irom_test_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source irom_test_top.tcl -notrace
