...
HD_PWD='Z:/25Spring/Vivado_lab/projects/project_4_change_inport/project_4.runs/lpm_rom_irom_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lpm_rom_irom.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lpm_rom_irom.tcl
