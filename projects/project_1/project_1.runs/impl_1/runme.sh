...
HD_PWD='Z:/25Spring/Vivado_lab/projects/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log alu_test_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source alu_test_top.tcl -notrace
