...
HD_PWD='Z:/25Spring/Vivado_lab/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log alu_test_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source alu_test_top.tcl
