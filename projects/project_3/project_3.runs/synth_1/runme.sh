...
HD_PWD='Z:/25Spring/Vivado_lab/projects/project_3/project_3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TB_sc_computer.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TB_sc_computer.tcl
