...
HD_PWD='Z:/25Spring/Vivado_lab/Final_Project/Final_Project/Final_Project.runs/lpm_ram_dq_dram_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lpm_ram_dq_dram.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lpm_ram_dq_dram.tcl
