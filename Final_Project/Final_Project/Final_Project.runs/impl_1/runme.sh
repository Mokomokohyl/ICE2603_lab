...
HD_PWD='Z:/25Spring/Vivado_lab/Final_Project/Final_Project/Final_Project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sc_cpu_iotest.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sc_cpu_iotest.tcl -notrace
