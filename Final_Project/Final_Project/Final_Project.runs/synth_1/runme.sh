...
HD_PWD='Z:/25Spring/Vivado_lab/Final_Project/Final_Project/Final_Project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sc_cpu_iotest.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sc_cpu_iotest.tcl
